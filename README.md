...
[deconstructions hub](https://siwill22.github.io/deconstructions/) rather than this file —
...
mkdir -p archive && curl -L \
  https://github.com/siwill22/Geode/releases/download/data-v23/archive-deploy.tar.gz \
  | tar -xz -C archive
```
...
deployable archive is **~770 MB** (data-v23, measured 2026-09-26) — over three-quarters of the 1 GB cap
...
| | |
|---|---|
| Published Pages site | **1 GB hard** — currently **~770 MB** (data-v23) |
